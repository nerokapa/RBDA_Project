...
movies = ['Justice League', 'Ragnarok', 'Daddy\'s Home', 'Murder on the Orient Express'
                     'Wonder', 'The Star', 'A Bad Moms Christmas', 'Tumhari Sulu', 'Qarib Qarib Singlle', 'Verna']


def etl_mapper(input=sys.stdin, output=sys.stdout):
    for in_key, in_value in clean_tweet_generator(input):
        for movie in movies:
